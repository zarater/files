...
public class Tree {
    ...
    //This function breaks a full node into the correct branches of parent
    ...
    public void Display(Tree root, int flag){
        ...
        if(root.head[0].flag == flag){
            root.head[0].Display(head[0], 0);
            return;
        }
        if(root.head[1].flag == flag){
            root.head[1].Display(head[1], 0);
            return;
        }
        else{
            if(root.head[0].flag < flag){
    ...
    public void Display_all(Tree root){
        ...
        root.head[0].Display(root.head[0], 0);
        root.head[1].Display(root.head[1], 0);
